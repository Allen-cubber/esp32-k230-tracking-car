...
CONTROL_INTENT_PHRASES = (
    "前进", "向前", "往前", "前走", "后退", "倒车", "退后", "往后", "向后",
    "左转", "右转", "向左", "向右", "往左", "往右", "转弯", "转一下", "转一圈",
    "停车", "停住", "停一下", "刹车", "动一下", "走一下", "移动",
    "开始跟随", "继续跟随", "恢复跟随", "跟着我", "跟我走", "跟随我", "追踪我",
    "暂停跟随", "停止跟随", "别跟了", "不要跟了", "保持不动", "原地待命", "待命",
    "靠近", "过来", "离我近", "离我远",
    "云台", "镜头", "摄像头", "看前面", "看中间", "回中", "回正",
    "点头", "点点头", "摇头", "摇摇头", "锁定", "解锁",
)
...
def is_control_intent(text: str) -> bool:
    compact = _compact_text(text)
    if not compact:
        return False
    return any(phrase in compact for phrase in CONTROL_INTENT_PHRASES)
